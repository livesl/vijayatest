<header id="topNav" class="topHead" style=""><!-- remove class="topHead" if no topHead used! -->
            ...
            <nav class="nav-main mega-menu">
                <ul class="nav nav-pills nav-main scroll-menu" id="topMain">
                    ...
                    <li class="  mega-menu-item mega-menu-two-columns">
                        <a class="active" href="portfolio.php">
                            Portfolio <i class=""></i>
                        </a>
                        <!--								<ul class="dropdown-menu">
                                                                                                <li>
                    ...
                    <li class=" mega-menu-item mega-menu-fullwidth">
                        <a class="" href="" data-toggle="modal" data-target=".bs-example-modal-lg" id="studentdeatails">
                            Exam Results <i class=""></i>
                        </a>
                        <!--							
                                                                                </li>
