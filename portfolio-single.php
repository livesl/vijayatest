...
<!-- Mirrored from theme.stepofweb.com/Atropos/v1.7/HTML/portfolio-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Mar 2016 14:13:49 GMT -->
<head>
		<meta charset="utf-8" />
		<?php
	...
	<body><!-- Available classes for body: boxed , pattern1...pattern10 . Background Image - example add: data-background="assets/images/boxed_background/1.jpg"  -->
			...
			<div class="container">
				...
				<div class="pull-right nav signin-dd">
					...
					<div class="dropdown-menu" role="menu" aria-labelledby="quick_sign_in">
						...
						<h4>Sign In</h4>
						<form action="http://theme.stepofweb.com/Atropos/v1.7/HTML/page-signin.html" method="post" role="form">
		...
		<div id="wrapper">
			...
			<section id="portfolio" class="container">
				...
				<h2><strong>Atropos</strong> project example</h2>
				...
				<div class="row">
					<div class="col-sm-6 col-md-7">
						<div class="owl-carousel controlls-over product-image" data-plugin-options='{"items": 1, "singleItem": true, "navigation": true, "pagination": true, "transitionStyle":"fadeUp"}'>
							<div>
								<img alt="" class="img-responsive" src="assets/images/demo/portfolio/scouter.jpg">
							</div>
							<div>
...
<!-- Mirrored from theme.stepofweb.com/Atropos/v1.7/HTML/portfolio-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Mar 2016 14:13:50 GMT -->
</html>